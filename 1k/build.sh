...
OPENSSL_CONFIG_ALL_OPTIONS="$OPENSSL_CONFIG_TARGET $OPENSSL_CONFIG_OPTIONS -DBN_LLONG=1 -DRC4_CHAR=1 --prefix=$openssl_install_dir --openssldir=$openssl_install_dir"
